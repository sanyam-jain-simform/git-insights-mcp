...
import { listRecentCommits, listRecentCommitsSchema, searchCommits, searchCommitsSchema, } from "./tools/commits.js";
import { getCommitDiff, getCommitDiffSchema, getDiffBetweenBranches, getDiffBetweenBranchesSchema, } from "./tools/diff.js";
import { getBranchStatus, getBranchStatusSchema, listBranches, listBranchesSchema, } from "./tools/status.js";
import { getFileHistory, getFileHistorySchema, blameFile, blameFileSchema, } from "./tools/fileHistory.js";
...
server.registerTool("list_recent_commits", {
    title: "List recent commits",
    description: "Get the most recent commits on a branch, with author, date, and message.",
...
server.registerTool("get_diff_between_branches", {
    title: "Get diff between branches",
    description: "Show the diff and change summary between two branches or refs.",
...
server.registerTool("get_branch_status", {
    ...
    description: "Show current branch, ahead/behind counts, and any uncommitted changes.",
...
server.registerTool("blame_file", {
    title: "Blame file",
    description: "Show line-by-line commit/author attribution for a file (git blame).",
